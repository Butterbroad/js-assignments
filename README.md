...
* Edit local README.md file and update all links (just replace all occurrences of `'butterbroad'` with your account name).
...
```
* Open https://github.com/butterbroad/js-assignments and test the build icon. Now it will run all tests and update status once you push changes to github. Keep this icon green!
...
* Push your updates to github server and check if tests passed on [travis-ci](https://travis-ci.org/butterbroad/js-assignments/builds).
